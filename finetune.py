...
swanlab_callback = SwanLabCallback(
    project="220",
    experiment_name="Qwen2-72B-Instruct",
    description="使用通义千问Qwen2-72B-Instruct模型在APE2k数据集上微调。",
    config={
...
def train():
    ...
    trainer = Trainer(
        ...
        model=model, tokenizer=tokenizer, args=training_args, callbacks=[swanlab_callback], **data_module
    )
    ...
    for index, row in test_df.iterrows():
        ...
        test_text_list.append(messages)
